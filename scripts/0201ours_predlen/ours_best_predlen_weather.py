...
# Best-so-far from 0201_graphsweep_* on weather (pl96): TODO (using ETTm1/flotation config for now)
CFG = {
    "tag": "S4_l1s1_b-2",
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run our best config across pred_len on weather.")
    parser.add_argument("--python", dest="python_bin", default=sys.executable)
    parser.add_argument("--root_path", default="./datasets")
    parser.add_argument("--label_len", type=int, default=48)
    parser.add_argument("--pred_lens", default="", help="comma-separated pred_lens to run (default: 96,192,336)")
