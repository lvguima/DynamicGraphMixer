...
# Best-so-far from 0201_graphsweep_* on flotation (pl4): S4_l1s1_b-2
CFG = {
    "tag": "S4_l1s1_b-2",
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run our best config across pred_len on flotation.")
    parser.add_argument("--python", dest="python_bin", default=sys.executable)
    parser.add_argument("--root_path", default="./datasets")
    parser.add_argument("--label_len", type=int, default=48)
    parser.add_argument("--pred_lens", default="", help="comma-separated pred_lens to run (default: 2,4,6)")
